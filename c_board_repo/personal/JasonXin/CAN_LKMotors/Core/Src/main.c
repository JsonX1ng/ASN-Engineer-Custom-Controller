...
void StartLibraryHandler(void *argument)
{
  /* USER CODE BEGIN 5 */
	...
	CAN_RM_Init_Buses(BUS1, BUS2);
	CAN_LK_InitMotor(1,1);
...
void StartMainTask(void *argument)
{
  /* USER CODE BEGIN StartMainTask */
	//float TestingPID[3] = {10.0,0.0,0.01};
  /* Infinite loop */
  for(;;)
  {
//	int16_t readPosA = getC620Pos(BUS1, 1);
//	int16_t readPosB = getC620Pos(BUS1, 2);
//	int16_t readPosC = getC620Pos(BUS1, 3);
//	UART_Printf(UART2,"$%d %d;",readPosA,readPosB,readPosC);
	uint8_t buttonPressed = !HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0);
//	if (buttonPressed) {
//		setC620RPM(BUS1, 1, 2000, TestingPID);
//		setC620RPM(BUS1, 2, 2000, TestingPID);
//	} else {
//		setC620RPM(BUS1, 1, 0, TestingPID);
//		setC620RPM(BUS1, 2, 0, TestingPID);
//	}
	if (buttonPressed) {
//		setLKAngleSingle(1, 9000, 0,200,200,1);
//		setLKAngleSingle(2, 9000, 0,50,50,1);
		setLKRPM(1, 300, 50, 50);
		setLKRPM(2, 300, 70, 70);
	...
	//uint32_t readPosA = getLKAngleSingle(2);
	//UART_Printf(UART2,"$%d;",readPosA);
    osDelay(5);
  }
